...
# CAME FROM: GettingStartedHowTo.md -> Quick index points here for edit-frequency context.
# NEXT: Keep it nearby while coding; update if your team’s habits change. See ::--:: GettingStartedHowTo.md for the entry point.
...
- **GettingStartedHowTo.md** — Occasional when setup steps change.
- **README.md** — Rare; update when front-page links or the short description changes.
